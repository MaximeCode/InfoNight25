		...
		<>
			...
			<section className="mx-auto max-w-6xl px-4 py-10 md:px-6 md:py-20">
				<div className="text-center max-w-3xl mx-auto space-y-6">
					...
					<h1 className="text-3xl md:text-5xl text-emerald-950 font-bold tracking-tight">
					...
					<div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
						<Button className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-6 text-lg w-full sm:w-auto">
			...
			{/* ChatBot */}
			<section className="text-center mx-auto w-full md:w-3/4 px-4 py-10 md:px-6 md:py-16">
				<h2
