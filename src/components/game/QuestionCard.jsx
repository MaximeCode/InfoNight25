...
export function QuestionCard({ question, onAnswer, totalQuestions, currentQuestionIndex }) {
  ...
  return (
    ...
    >
      <Card variant="parchment" className="p-8 min-h-[400px] flex flex-col justify-between relative overflow-visible">
        {/* Header */}
